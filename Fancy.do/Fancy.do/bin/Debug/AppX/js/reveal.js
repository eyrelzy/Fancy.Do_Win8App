...
var Reveal = (function(){
	...
	function setupDOM() {
		...
		if( !dom.wrapper.querySelector( '.controls' ) ) {
			...
			controlsElement.innerHTML = '<div class="navigate-left"></div>' +
										...
										'<div class="navigate-center enabled"></div>';
		...
		if ( config.controls ) {
			...
			dom.controlsCenter = toArray( document.querySelectorAll( '.navigate-center' ) );
	...
	function addEventListeners() {
		...
		if ( config.controls && dom.controls ) {
			[ 'touchstart', 'click' ].forEach( function( eventName ) {
				...
				dom.controlsCenter.forEach( function( el ) { el.addEventListener( eventName, onNavigateCenterClicked, false ); } );
	...
	function removeEventListeners() {
		...
		if ( config.controls && dom.controls ) {
			[ 'touchstart', 'click' ].forEach( function( eventName ) {
				...
				dom.controlsCenter.forEach( function( el ) { el.removeEventListener( eventName, onNavigateCenterClicked, false ); } );
	...
	function updateControls() {
		...
		if ( config.controls && dom.controls ) {
			...
			//if( routes.center ) dom.controlsCenter.forEach( function( el ) { el.classList.add( 'enabled' ); } );
			// Prev/next buttons
	...
	function onNavigateCenterClicked( event ) { event.preventDefault(); navigateCenter(); }
